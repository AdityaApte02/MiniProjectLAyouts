...
public class Login extends AppCompatActivity {
    ...
    private static EditText mCountryCode;
    private static EditText phone_number;
    private static Button generate_otp;

    private static ProgressBar mLoginProgress;

    private static TextView mLoginFeedbackText;
        ...
        generate_otp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String phone = phone_number.getText().toString();
                 ...
                 complete_phone_number = "+" + country_code + phone;
